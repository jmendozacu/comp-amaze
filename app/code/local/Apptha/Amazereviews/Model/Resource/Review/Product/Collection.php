...
class Apptha_Amazereviews_Model_Resource_Review_Product_Collection extends Mage_Catalog_Model_Resource_Product_Collection
{
 /**
     * Entities alias
     *
    ...
    //WE HAVE OVERWRITE THIS FUNCTION FROM CORE. WE ADD THREE CUSTOM FIELDS NAMED 'counter_yes', 'counter_no' AND 'abuse_counter'. HERE WE ADD OUR CUSTOM FIELDS TO OUR THIS JOIN QUERY
  ...
  $this->getSelect()
            ->join(array('rt' => $reviewTable),
                ...
                array('rt.review_id', 'review_created_at'=> 'rt.created_at', 'rt.entity_pk_value', 'rt.status_id','rt.abuse_counter', 'rt.counter_no','rt.counter_yes'))
